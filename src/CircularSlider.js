...
export default class CircularSlider extends PureComponent {
  ...
  constructor(props) {
    ...
    this.wakeHourRotation = 0;
    this.sleepHourRotation = 0;

    this.wakeHourParameter = {
      currentAngle: null,
      previousAngle: null,
      rotation: 0,
    };
  ...
  componentWillMount() {
    this._sleepPanResponder = PanResponder.create({
      ...
      onPanResponderMove: (evt, { moveX, moveY }) => {
        ...
        const angleInDeg = parseInt(this.radianToDegree(newAngle));
        ...
        this.wakeHourParameter.previousAngle = this.wakeHourParameter.currentAngle;
        this.wakeHourParameter.currentAngle = angleInDeg;
